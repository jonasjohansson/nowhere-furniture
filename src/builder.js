...
import { SHEETS, TIMBER, MM } from './stock.js?v=15';
import { disposeWoodCache } from './wood.js?v=15';
import { materialMaterial } from './materials.js?v=15';
import { createWoodMaterial as woodPhotoMaterial, disposeWoodCache as disposePhotoCache } from './wood-photo.js?v=15';
