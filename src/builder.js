...
import { SHEETS, TIMBER, MM } from './stock.js?v=16';
import { disposeWoodCache } from './wood.js?v=16';
import { materialMaterial } from './materials.js?v=16';
import { createWoodMaterial as woodPhotoMaterial, disposeWoodCache as disposePhotoCache } from './wood-photo.js?v=16';
